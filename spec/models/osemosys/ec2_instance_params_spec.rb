...
RSpec.describe Osemosys::Ec2InstanceParams do
  describe 'to_h' do
    it 'passes the instance_type param' do
      params = Osemosys::Ec2InstanceParams.new(instance_type: 'my-instance-type', run_id: 1).to_h
    ...
    context 'when the instance type supports cpu options' do
      it 'includes cpu options' do
        params = Osemosys::Ec2InstanceParams.new(instance_type: 'c5.9xlarge', run_id: 1).to_h
    ...
    context 'when the instance type does not support cpu options' do
      it 'does not include cpu options' do
        params = Osemosys::Ec2InstanceParams.new(instance_type: 't2.micro', run_id: 1).to_h
